...
void PhysicsState::Init(GLFWwindow* _window, GameStateManager* _gameStateManager) {
	...
	for (int i = 0; i <= 10; i++) {
		m_spheres.push_back(new Sphere(glm::vec3(cosf(i), 30, sinf(i)), glm::vec3(0, 0, 0), 3, 3, glm::vec4(1, 0, 1, 1)));
	}
	...
	m_cube[0] = new Cube(glm::vec3(-50, 10, 0), glm::vec3(2, 10, 52), glm::vec3(0), 1000, glm::vec4(0, 0, 1, 1));
	m_cube[1] = new Cube(glm::vec3(0, 10, -50), glm::vec3(52, 10, 2), glm::vec3(0), 1000, glm::vec4(0, 0, 1, 1));
	m_cube[2] = new Cube(glm::vec3(50, 10, 0),  glm::vec3(2, 10, 52), glm::vec3(0), 1000, glm::vec4(0, 0, 1, 1));
	m_cube[3] = new Cube(glm::vec3(0, 10, 50),  glm::vec3(52, 10, 2), glm::vec3(0), 1000, glm::vec4(0, 0, 1, 1));
	...
	m_physicsScene->AddActor(new Spring(m_spheres.front(), m_spheres.back()));
}
